 ...
 */
public class StopFollowingDialog extends DialogFragment {
     ...
     */
    public static StopFollowingDialog newInstance(String friendUserId, int position) {
        StopFollowingDialog dialog = new StopFollowingDialog();
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        builder.setMessage("Do you really want to remove your friend??")
                ...
                .setNegativeButton("Keep friend", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        StopFollowingDialog.this.getDialog().cancel();
                    }
                });
